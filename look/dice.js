...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-422cfa71');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-422cfa71');}
...
var brandEl=document.querySelector('.rl-brand-422cfa71');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
